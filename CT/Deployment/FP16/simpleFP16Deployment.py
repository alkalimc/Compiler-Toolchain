...
from CT.Deployment.FP16.deployment import Deployment
from CT.Deployment.FP16.eagerDeployment import EagerDeployment


@dataclass
class SimpleFP16Deployment():
    model_id: str = field(default="Qwen2.5-7B-Instructs")
